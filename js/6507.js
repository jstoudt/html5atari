...
CPU6507.prototype._fetchInstruction = function() {
...
CPU6507.prototype._addWithCarry= function( val ) {
	...
	if ( this._statusIsSet( 'D' ) ) {
		val = this.BCD_TO_DEC[val] + this.BCD_TO_DEC[this.regSet.ac];
...
CPU6507.prototype._subtractWithCarry = function( val ) {
	...
	if ( this._statusIsSet( 'D' ) ) {
		val = this.BCD_TO_DEC[this.regSet.ac] - this.BCD_TO_DEC[val];
